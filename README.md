...
2. Clone this project and install dependencies with `bun install --frozen-lockfile`
3. Run `bun run login` to login to your Cloudflare account in Wrangler
4. Run `bun run deploy` to publish the API to Cloudflare Workers
